// Combined script for both setup and seeding
...
async function run() {
  try {
    ...
    console.log("Moving to database seeding...");
    await seedDatabase();
    
    console.log("Database setup and seeding completed successfully!");
  } catch (error) {
    console.error("Error in database setup and seeding:", error);
    process.exit(1);
  }
}

// Run both setup and seeding
run();